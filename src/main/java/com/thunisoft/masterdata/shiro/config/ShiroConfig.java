package com.thunisoft.masterdata.shiro.config;

import com.thunisoft.masterdata.shiro.filter.MyAuthenticationFilter;
import com.thunisoft.masterdata.shiro.realm.MyRealm;
...
public class ShiroConfig {
   ...
   public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
      ...
      filterMap.put("authentication", new MyAuthenticationFilter());
...
//      myShiroRealm.setCredentialsMatcher(hashedCredentialsMatcher());
   ...
   public SecurityManager securityManager(){
      ...
      MyRealm myShiroRealm = myShiroRealm();
